...
EMS_CustomMapConfig = {
    ...
    Callback_OnGameStart = function()
        StartCountdown(20 * 60, OnOpenTerritoriesTimerFinished, false);
    end,
...
function OnOpenTerritoriesTimerFinished()
    RemoveBlockRocksToMakeOutpostsAccessable();
    Message("@color:238,221,130 Die Territorien sind nun erreichbar!");
    Sound.PlayGUISound(Sounds.Misc_so_signalhorn, 70);
    StartCountdown(25 * 60, OnOpenCenterAndWinterBridgesTimerFinished, false);
...
function OnOpenCenterAndWinterBridgesTimerFinished()
    RemoveBlockRocksToOpenCenterAndWinterBridges();
    Message("@color:238,221,130 Die Wege über die Mitte wurden freigegeben!");
    Sound.PlayGUISound(Sounds.Misc_so_signalhorn, 70);
    StartRain(30);
end
...
function RemoveBlockRocksToOpenCenterAndWinterBridges()
